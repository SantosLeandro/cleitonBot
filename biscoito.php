...
$biscoito = array(
  ...
  return "Biscoito da sorte: ".$biscoito[rand(0, count($biscoito) - 1)];
}

function genNumSorte(){
  $numbers = range(1,60);
  shuffle($numbers);
  return "Numeros da sorte: $numbers[0] - $numbers[1] - $numbers[2] - $numbers[3] - $numbers[4] - $numbers[5]";
}
